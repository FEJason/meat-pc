module.exports = {
    ...
    sectionPage: {
        ...
        brandDesc1: "BTXCHAIN.COM由一群比特幣早期參與者與極客創立，團隊核心成員來自於谷歌、微軟、阿里巴巴、騰訊等知名企業，具有深厚的研發實力與豐富的互聯網產品運營經驗。",
        brandDesc2: "BTXCHAIN.COM定位於區塊鏈基礎服務商，致力於為全球用戶提供優質加密資產交易平台，秉承著“不作惡”的基本原則，堅持誠實、公正、熱情的服務於客戶，以開放的態度迎接一切有利於用戶根本利益的伙伴/項目。",
    ...
    activity: {
        ...
        attentiontxt4: "* 本活動最終解釋權歸幣嚴(WWW.BTXCHAIN.COM)官方所有",
        inputamount: "輸入兌換數量",
    ...
    invite: {
        ...
        partnerlevel: "合夥級別",
        ruledetail: "規則詳情",
        ruleprofile1: "幣嚴(WWW.BTXCHAIN.COM)的【推廣合夥人】是全網",
        ruleprofile2: "返佣比例最高、",
        ruleprofile3: "返佣時長最長(最高終身返佣)",
        ruleprofile4: "的推廣活動，讓付出相應努力的推廣者能夠成為真正意義上的平台“合夥人”，享受與幣嚴(WWW.BTXCHAIN.COM)交易平台共同成長的紅利！具體細則如下：",
        ruletext1: "一、為佈道數字資產理念與擴大用戶規模，幣嚴(WWW.BTXCHAIN.COM)推出【推廣合夥人】計劃，該活動長期有效。",
        ...
        ruletext8: "八、推廣返佣排行榜TOP10或TOP100不定期會獲得由幣嚴(WWW.BTXCHAIN.COM)官方發放的額外獎勵。",
        ruletext9: "九、如其他活動與【推廣合夥人】活動衝突，則經協商後決定是否臨時變更，望諸合夥人諒解。",
        ruletext10: "十、L4(巡撫)、L5(太守)、L6(節度使)級合夥人分別享受每年返佣總額的5%、10%、15%的分紅獎勵。",
        ruletext11: "十一、本活動最終解釋權歸幣嚴(WWW.BTXCHAIN.COM)所有。",
        ...
        thanks: "感謝您陪著幣嚴(WWW.BTXCHAIN.COM)一起成長！",
        headertip: "以上佣金數據非實時更新，系統每24H統計並更新一次。",
        ptools: "推廣工具箱",
        pt_title: "數字貨幣禮品卡",
        pt_desc: "兌換後自動成為下級好友，送朋友、送親人、送客戶、送夥伴。助力推廣合夥人更好推廣。",
        pt_more: "更多工具，敬請期待",
        pt_tips: "如果您有好的創意，請發送郵件至promotion@BTXCHAIN.COM，採納後有獎勵哦！",
        pt_card_amount: "卡面金額",
        ...
        pt_card_rule2: "二、免費禮品卡每個用戶限兌1份。由幣嚴(WWW.BTXCHAIN.COM)官方發放的免費禮品卡，每個用戶限兌一份，即使通過不同用戶領取到不同兌換碼的免費禮品卡，也只能兌換1份。自定義製作禮品卡不受此限制。",
        ...
        pt_card_rule6: "六、免費禮品卡最終解釋權歸BTXCHAIN.COM所有。",
        pt_card_day: "天",
    ...
    description: {
        ...
        message5: '幣嚴(WWW.BTXCHAIN.COM)國際數字加密資產交易平台手機客戶端，專注掌上交易體驗',
        scanqrcode: "掃描二維碼，下載APP",
        aboutdesc1: "幣嚴(WWW.BTXCHAIN.COM)是技術全球領先的數字資產交易平台，註冊於開曼群島，核心運營團隊位於香港。幣嚴(WWW.BTXCHAIN.COM)核心成員來自於頂級互聯網和金融公司，大部分成員是深度比特幣和區塊鏈信仰者，我們深信區塊鏈將改變傳統壟斷性金融體系，會建立一個更加民主、自治的社會結構。",
        aboutdesc2: "幣嚴(WWW.BTXCHAIN.COM)平台擁有專業金融級別的交易架構，擁有自主研發的高並發內存撮合交易引擎，平台採用全冷充值錢包系統+多重簽名+高防護DDOS攻擊系統等交易架構，保證客戶資產安全。",
        aboutdesc3: "幣嚴(WWW.BTXCHAIN.COM)為了讓客戶更好的把握投資機會，客服部門內部採用扁平化管理，建立了極速服務響應機制，資產客服經理常年7*24H在線，為客戶提供資產充值提現等服務，保障客戶在25分鐘內完成資產充提。",
        aboutdesc4: "幣嚴(WWW.BTXCHAIN.COM)嚴格篩選優質項目並提供安全穩定的資產託管服務。幣嚴(WWW.BTXCHAIN.COM)秉承著“誠實、公正、熱情、開放”的理念，竭力為用戶打造安全、可靠、高效和友好的極致交易所。",
        ...
        community: "幣嚴社區",
        wechat: "微信",
        addwechat: "添加 “BTXCHAIN01” 為微信好友，進入微信福利社群",
        weibo: "微博",
        twitter: "推特",
        biyong: "幣用",
        telegram: "電報",
