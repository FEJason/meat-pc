module.exports = {
    ...
    sectionPage: {
        ...
        brandDesc1: "BTXCHAIN.COM由一群比特币早期参与者与极客创立，团队核心成员来自于谷歌、微软、阿里巴巴、腾讯等知名企业，具有深厚的研发实力与丰富的互联网产品运营经验。",
        brandDesc2: "BTXCHAIN.COM定位于区块链基础服务商，致力于为全球用户提供优质加密资产交易平台，秉承着“不作恶”的基本原则，坚持诚实、公正、热情的服务于客户，以开放的态度迎接一切有利于用户根本利益的伙伴/项目。",
    ...
    invite: {
        ...
        pt_more: "更多工具，敬请期待",
        pt_tips: "如果您有好的创意，请发送邮件至promotion@BTXCHAIN.COM，采纳后有奖励哦！",
        pt_card_amount: "卡面金额",
        ...
        pt_card_rule6: "六、免费礼品卡最终解释权归BTXCHAIN.COM所有。",
        pt_card_day: "天",
    ...
    description: {
        ...
        community: "火牛社区",
        wechat: "微信",
        addwechat: "添加 “conbtc9” 为微信好友，进入微信福利社群",
        weibo: "微博",
        twitter: "推特",
        biyong: "币用",
        telegram: "电报",
